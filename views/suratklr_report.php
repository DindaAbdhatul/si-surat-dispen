                    ...
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th>
                                <th>No Surat</th>
                                <th width="30%">Tanggal Surat Keluar</th>
                                <th>Prihal</th>
                                <th>Tujuan Surat</th>
                                <th>Keterangan</th>
                                <th>ACTION</th>
                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['ket'] ?></td>
                                    <td>
                                        <a href="report/suratklr.php?id=<?= $data['id'] ?>" target="_blank" class="btn btn-info btn-xs">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="9">
                                    <a href="report/suratklr_semua.php" target="_blank" class="btn btn-info btn-sm">
